...
import "../../App.css";
import back from "../../images/backgrou.mp4"; // Changed background
...
function Level7Game() {
  ...
  const [obstacleSpeed, setObstacleSpeed] = useState(1.8); // Higher base speed for Level 7
  ...
  useEffect(() => {
    if (timeLeft > 0 && !gameOver && !allWordsCompleted) {
      const timer = setInterval(() => {
        ...
        setObstacleSpeed(prev => Math.min(prev + 0.025, 3.0)); // More aggressive speed increase for level 7
      }, 1000);
    ...
    <div className="App" style={{ backgroundColor: "black", height: "100vh" }}>
      <div className="game-container" style={{
        ...
        <div style={{
          ...
          top: "120px",
          right: "20px",
          color: obstacleSpeed > 2.5 ? "#ff4444" : "#2196F3",
          fontSize: "20px",
          fontWeight: "bold",
          background: "rgba(0,0,0,0.7)",
          padding: "10px",
        ...
        {gameOver && (
          <div style={{
            ...
            {levelPassed ? (
              <p style={{ color: "#2196F3" }}>Level Passed! You can proceed to Level 8!</p>
            ) : (
