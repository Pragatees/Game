...
const level5Words = [
  // 4 letter words
  "able", "bird", "calm", "dark", "echo", "find", "glow", "hope", "jump", "kind",
  "life", "move", "note", "open", "park",
  // 5 letter words
  "alive", "brave", "claim", "dream", "extra", "flash", "grand", "happy", "image", "judge",
  "kneel", "learn", "magic", "noble", "ocean"
];
...
{gameOver && (
          <div style={{
            ...
            {levelPassed ? (
              <p style={{ color: "#4CAF50" }}>Level Passed! You can proceed to Level 6!</p>
            ) : (
            ...
            {levelPassed && (
              <button
                onClick={() => window.location.href = "/level6"}
                style={{
                  ...buttonBaseStyle,
